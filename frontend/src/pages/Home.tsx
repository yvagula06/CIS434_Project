...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Top Navigation Bar */}
      <div className="bg-gradient-to-r from-orange-500 to-pink-500 px-6 py-3 flex justify-between items-center shadow-lg">
          ...
          {authLoading ? (
            ...
            <>
              ...
              <button
                ...
                className="bg-orange-700 text-white px-4 py-2 rounded-lg font-semibold hover:bg-orange-800 transition"
              >
                Sign Up
              </button>
            </>
